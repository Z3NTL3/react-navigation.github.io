...
For example, when you press the back button of a stack navigator nested within another navigator, it will go to the previous screen of the closest ancestor navigator, which is the stack navigator in this case.
